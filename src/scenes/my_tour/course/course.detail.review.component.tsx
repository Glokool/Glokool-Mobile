...
import { CourseDetailReviewScreenProps } from '../../../navigation/course.navigator';
import {
    faBook,
    faCommentDots,
    faUser,
...
export const CourseDetailReviewScreen = (props: CourseDetailReviewScreenProps): LayoutElement => {
    ...
    const PressOverview = (id) => {
        props.navigation.navigate(SceneRoute.COURSE_DETAIL_OVERVIEW, id);
    }

    const PressSpots = (id) => {
        props.navigation.navigate(SceneRoute.COURSE_DETAIL_SPOTS, id);
    }
      ...
      <React.Fragment>
          ...
          <Layout style={styles.bottomBar}>
           ...
           <Layout style={styles.tabbar}>
                ...
                <Layout style={styles.tabbarContainer}>
                    <TouchableOpacity onPress={() => PressOverview(CourseData.id)}>
                ...
                <Layout style={styles.tabbarContainer}>
                    <TouchableOpacity>
                        <Text style={styles.selectTitle}>Review</Text>
                    </TouchableOpacity>
                </Layout>
            </Layout>
